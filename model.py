...
class Decoder(nn.Module):
    ...
    def forward(self, x, encoder_output, src_mast, tgt_mask):
        for layer in self.layers:
            x = layer(x, encoder_output, src_mast, tgt_mask)
        return self.norm(x)
...
# Translation example combining blocks to build an encoder-decoder translation model
